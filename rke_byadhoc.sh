...
r2_help () {
    ...
    echo "gcp: Devuelve la URL para acceder a la consola de GCP (DevOps). Uso: r2 gcp symmetria"
    echo "reg: Devuelve la URL para acceder a los logs históricos desde GCP. Uso: r2 reg perfit"
